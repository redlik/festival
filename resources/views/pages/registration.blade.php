    ...
    <div class="py-0 md:py-12">
        ...
        <div class="bg-gray-100 p-6 rounded my-8">
            ...
            <ul class="list-decimal list-inside">
                ...
                <li>Please refer to the programme of events for last year's <a href="{{ asset('img/Kerrywellfest2024.pdf') }}" class="underline font-bold" target="_blank">Fest (2024)</a> which will remain on the website for the foreseeable future. We would be delighted to facilitate events of a similar nature as well as events that will bring something new and different to the Fest. We are particularly interested in events for adolescents and young adults, as they have been lacking in previous years.</li>
