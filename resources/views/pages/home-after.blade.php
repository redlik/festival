    ...
    <div id="hero" class="bg-center bg-gray-100 md:bg-[url('/img/home-hero-23.jpg')] bg-cover bg-no-repeat">
        <div class="max-w-7xl mx-auto px-0 lg:px-8 flex flex-wrap items-end pt-0 lg:pb-12 lg:pt-[500px]">
            ...
            <div class="w-full lg:w-2/3 p-4 lg:rounded-lg backdrop-blur"
                ...
                <h1 class="text-2xl lg:text-4xl mb-4 fancy font-semibold">Thank you for participating in Kerry Mental Health & Wellbeing
                    Fest</h1>
                <div class="font-semibold lg:text-lg text-gray-800 mb-4">
                    Thanks to all those who participated in the 2024 Kerry Mental Health & Wellbeing Fest. Join us again in 2025, from Saturday, 4th October to Saturday, 11th October for a diverse programme of free events around the county.
                </div>
                <a href="{{ route('events') }}">
                    <button class="button-primary">View 2024 Events</button>
                </a>
            </div>
        </div>
    </div>
                    ...
                    <div
                        ...
                        <div x-transition:enter="transition ease-out duration-300"
                            ...
                            <div @click.away="showPoster = false"
                                ...
                                <div class="p-2">
                                    <img loading="lazy"
                                         src="{{asset('img/Kerrywellfest2024-hires.jpg')}}" alt=""
