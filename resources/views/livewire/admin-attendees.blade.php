    ...
    <div class="flex items-center justify-between gap-16 mb-4 bg-gray-100 px-4 py-2 rounded">
        <div class="flex items-center gap-16">
            <div class="w-full lg:w-1/2 flex-shrink-0">
                <input type="search" wire:model.live.debounce.500ms="searchAttendee" name="search"
                       class="focus:ring-olive-500 text-gray-600 border-gray-300 w-full rounded block px-2 py-1"
            ...
            <div class="w-full lg:w-1/4 flex items-center">
                <label for="events" class="mr-2 text-sm text-gray-600 shrink-0">Filter by event</label>
                <select name="events" wire:model.live="attendeeEvent"
        ...
        <div>
            <x-collage.button wire:click="export">
                Export attendees
            </x-collage.button>
        </div>
    </div>
